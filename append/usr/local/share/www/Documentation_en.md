...
| openssh | [9.2p1](https://ftp.openbsd.org/pub/OpenBSD/OpenSSH/portable/openssh-9.2p1.tar.gz) | ssh and sftp used |
...
| clamav | [1.0.1](https://www.clamav.net/downloads/production/clamav-1.0.1.tar.gz) | Used for antivirus tests |
...
| DSAS website | [1.2.20](https://gitlab.com/groupe-edf/dsas-tinycore) | Backend and frontend of the administration site |
